...
public class ControleSistema {
	...
	public boolean adicionarApostaCenario(int numCenario, String nomeApostador, double qtnAposta, boolean previsao){
	...
	public static void main(String[] args) {
		ControleSistema c = new ControleSistema(0.11,1000);
		c.cadastrarCenario("Tomar muito café");
		c.cadastrarCenario("tomar pouco café");
