...
public class Aposta {
     ...
     * @return
     *      Uma variavel que representa esta quantia.
     */
     ...
     * @return
     *      Um booelan que representa descrição.
     */
     ...
     * @return
     *      uma váriavel String que representa a Aposta.
     */
	@Override
    ...
    /**
     * Função que agrupa todas as exceções contidas na construção os objetos do tipo Aposta.
     * @param nome
    ...
    /**
     * Metodo com a obrigação de transformar previsões em String para Boolean, além de lança as exceções dessa operação.
     * @param previsaoString
     * @return
     */
    ...
    /**
     * Metodo que representa a saída de Boolean para string do resultado da aposta.
     * @return
     *          Uma Boolean representando a antiga string descrita pelo usuário.
     */
